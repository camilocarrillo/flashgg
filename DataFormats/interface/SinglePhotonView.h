...
public:
    ...
    float pfChIso02WrtChosenVtx() const {
        return photon().pfChgIso02WrtVtx(dipho_->vtx());
    }
    float pfChIso03WrtChosenVtx() const {
        return photon().pfChgIso03WrtVtx(dipho_->vtx());
    }
    float pfChIso04WrtChosenVtx() const {
        return photon().pfChgIso04WrtVtx(dipho_->vtx());
    }

    float phoIdMvaWrtChosenVtx() const {
        return photon().phoIdMvaDWrtVtx(dipho_->vtx());
    }

...
public:
    ...
    bool operator==(const ptr_type & rhs) const {
        return ptr_ == rhs;
    }
    bool operator!=(const ptr_type & rhs) const {
        return ptr_ != rhs;
    ...
    const cand_type& cand() const {
        return *ptr_;
    }
    ptr_type ptr() const {
        return ptr_;
    }
    void setPtr(ptr_type x) {
        ptr_ = x;
    }
    ...
    void setGenIso(float x) {
        genIso_ = x;
    }

    bool frixioneIso() const {
        return frixioneIso_;
    }
    void setFrixioneIso(bool x) {
        frixioneIso_ = x;
    }

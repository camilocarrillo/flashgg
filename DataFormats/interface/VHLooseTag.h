...
public:
    ...
    const edm::PtrVector<pat::Muon> muons() const {
        return Muons_;
    }
    const edm::PtrVector<flashgg::Electron> electrons() const {
        return Electrons_;
    }
    const edm::PtrVector<Jet> jets() const {
        return Jets_;
    }
    const edm::PtrVector<pat::MET> met() const {
        return MET_;
    }

    void setJets(edm::PtrVector<Jet> Jets) {
        Jets_ = Jets;
    }
    void setMuons(edm::PtrVector<pat::Muon> Muons) {
        Muons_ = Muons;
    }
    void setMET(edm::PtrVector<pat::MET> MET) {
        MET_ = MET;
    }
    void setElectrons(edm::PtrVector<Electron> Electrons) {

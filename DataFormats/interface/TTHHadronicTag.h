...
public:
    ...
    const std::vector<edm::Ptr<flashgg::Jet> > jetVector() const {
        return theJetVec_;
    }
    const std::vector<edm::Ptr<flashgg::Jet> > bJetVector() const {
        return theBJetVec_;
    }
    int nBLoose() const {
        return Nbtagloose_;
    ...
    void setNBLoose(int nb) {
        Nbtagloose_ = nb;
    }
    void setNBMedium(int nb) {
        Nbtagmedium_ = nb;
    }

...
void GenJetvsTrueJet(int cat=1) {
    ...
    for (std::map<TString,TTree*>::iterator it=JetTree_PU20bx25.begin(); it!=JetTree_PU20bx25.end(); ++it) {
        h_PU20bx25_ptOffset[it->first] = new TH1F(Form("h_PU20bx25_ptOffset_%s",it->first.Data()),Form("%s  %s;p^{reco}_{t}/p^{gen}_{t}",it->first.Data(),label.second.Data()),200,0,10);
        h_PU40bx50_ptOffset[it->first] = new TH1F(Form("h_PU40bx50_ptOffset_%s",it->first.Data()),Form("%s  %s;p^{reco}_{t}/p^{gen}_{t}",it->first.Data(),label.second.Data()),200,0,10);

        h_PU20bx25_ptOffset_etacut[it->first] = new TH1F(Form("h_PU20bx25_ptOffset_etacut_%s",it->first.Data()),Form("%s  %s;p^{reco}_{t}/p^{gen}_{t}",it->first.Data(),label.second.Data()),200,0,10);
        h_PU40bx50_ptOffset_etacut[it->first] = new TH1F(Form("h_PU40bx50_ptOffset_etacut_%s",it->first.Data()),Form("%s  %s;p^{reco}_{t}/p^{gen}_{t}",it->first.Data(),label.second.Data()),200,0,10);

        h_PU40bx50_ptOffset_eta[it->first] = new TH2F(Form("h_PU40bx50_ptOffset_eta_%s",it->first.Data()),Form("%s  %s;#eta;p^{reco}_{t}/p^{gen}_{t}",it->first.Data(),label.second.Data()),150,-6,6,200,0,10);
        h_PU20bx25_ptOffset_eta[it->first] = new TH2F(Form("h_PU20bx25_ptOffset_eta_%s",it->first.Data()),Form("%s  %s;#eta;p^{reco}_{t}/p^{gen}_{t}",it->first.Data(),label.second.Data()),150,-6,6,200,0,10);

        h_PU40bx50_area_eta[it->first] = new TH2F(Form("h_PU40bx50_area_eta_%s",it->first.Data()),Form("%s  %s;#eta;JetArea_{FastJet}",it->first.Data(),label.second.Data()),150,-6,6,200,0,10);
        h_PU20bx25_area_eta[it->first] = new TH2F(Form("h_PU20bx25_area_eta_%s",it->first.Data()),Form("%s  %s;#eta;JetArea_{FastJet}",it->first.Data(),label.second.Data()),150,-6,6,200,0,10);

        // response vs pt / cathogories
        h_PU40bx50_res_pt_cat1[it->first] = new TH2F(Form("h_PU40bx50_res_pt_cat1_%s",it->first.Data()),Form("%s  %s;p_{t};p^{reco}_{t}/p^{gen}_{t}",it->first.Data(),"PU40bx50"),60,0,500,200,0,10);
        h_PU20bx25_res_pt_cat1[it->first] = new TH2F(Form("h_PU20bx25_res_pt_cat1_%s",it->first.Data()),Form("%s  %s;p_{t};p^{reco}_{t}/p^{gen}_{t}",it->first.Data(),"PU20bx25"),60,0,500,200,0,10);
        h_PU40bx50_res_pt_cat2[it->first] = new TH2F(Form("h_PU40bx50_res_pt_cat2_%s",it->first.Data()),Form("%s  %s;p_{t};p^{reco}_{t}/p^{gen}_{t}",it->first.Data(),"PU40bx50"),60,0,500,200,0,10);
        h_PU20bx25_res_pt_cat2[it->first] = new TH2F(Form("h_PU20bx25_res_pt_cat2_%s",it->first.Data()),Form("%s  %s;p_{t};p^{reco}_{t}/p^{gen}_{t}",it->first.Data(),"PU20bx25"),60,0,500,200,0,10);
        h_PU40bx50_res_pt_cat3[it->first] = new TH2F(Form("h_PU40bx50_res_pt_cat3_%s",it->first.Data()),Form("%s  %s;p_{t};p^{reco}_{t}/p^{gen}_{t}",it->first.Data(),"PU40bx50"),60,0,500,200,0,10);
        h_PU20bx25_res_pt_cat3[it->first] = new TH2F(Form("h_PU20bx25_res_pt_cat3_%s",it->first.Data()),Form("%s  %s;p_{t};p^{reco}_{t}/p^{gen}_{t}",it->first.Data(),"PU20bx25"),60,0,500,200,0,10);
        ...
        JetTree_PU20bx25[it->first]->Draw(Form("(bestPt/genJetPt):bestPt>>h_PU20bx25_res_pt_cat1_%s",it->first.Data()),Form("%s && abs(eta) <2.5",pt_cut_all.Data()),"PU40bx50");
        JetTree_PU40bx50[it->first]->Draw(Form("(bestPt/genJetPt):bestPt>>h_PU40bx50_res_pt_cat1_%s",it->first.Data()),Form("%s && abs(eta) <2.5",pt_cut_all.Data()),"PU20bx25");
        ...
        JetTree_PU20bx25[it->first]->Draw(Form("(bestPt/genJetPt):bestPt>>h_PU20bx25_res_pt_cat2_%s",it->first.Data()),Form("%s && abs(eta)>2.5 && abs(eta)<3.0",pt_cut_all.Data()),"");
        JetTree_PU40bx50[it->first]->Draw(Form("(bestPt/genJetPt):bestPt>>h_PU40bx50_res_pt_cat2_%s",it->first.Data()),Form("%s && abs(eta)>2.5 && abs(eta)<3.0",pt_cut_all.Data()),"");
        ...
        JetTree_PU20bx25[it->first]->Draw(Form("(bestPt/genJetPt):bestPt>>h_PU20bx25_res_pt_cat3_%s",it->first.Data()),Form("%s && abs(eta)>3.0 && abs(eta)<5.0",pt_cut_all.Data()),"");
        JetTree_PU40bx50[it->first]->Draw(Form("(bestPt/genJetPt):bestPt>>h_PU40bx50_res_pt_cat3_%s",it->first.Data()),Form("%s && abs(eta)>3.0 && abs(eta)<5.0",pt_cut_all.Data()),"");
